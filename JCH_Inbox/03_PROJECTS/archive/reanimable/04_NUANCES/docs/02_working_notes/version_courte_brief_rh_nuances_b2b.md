# Version courte - Mission Nuances B2B
...
- segmentation des cibles prioritaires ;
...
- creation de playbooks commerciaux ;
...
Competences finance et pilotage :
...
La disponibilite moyenne attendue est de 4 a 5 jours par mission et par consultant, a confirmer selon le perimetre exact.

La prestation est basee sur :

- un suivi du temps par timesheet ;
- le remboursement des frais inherents a la mission ;
- des presences ponctuelles chez Nuances ;
- la mise a disposition d'un bureau par Nuances lors des presences planifiees ;
- la designation par Nuances d'une personne de contact principale.

Nuances fournira les documents, modes d'emploi, supports de formation, informations techniques et acces aux outils existants necessaires a la bonne comprehension du projet.
...
- la pertinence du screening ;
- la qualite des questions de qualification ;
- la comprehension de la proposition de valeur ;
- le dossier preliminaire de rendez-vous ;
- les objections clients ;
- les donnees manquantes ;
- le lien entre opportunite commerciale et faisabilite technique.

A defaut d'un nombre encore defini, une premiere vague de 3 a 5 visites peut servir de pilote.
...
- fournir les documents et outils existants ;
- organiser une formation rapide sur les outils disponibles ;
- rendre disponibles les interlocuteurs internes necessaires ;
- organiser l'accompagnement terrain par un specialiste Nuances ;
- faciliter l'identification et la planification des visites prospects ;
