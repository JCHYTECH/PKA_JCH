# Synchronisation Google Drive Photos

**Created:** 2026-03-31 09:45  
**Updated:** 2026-03-31 09:46  
**Messages:** 3
...
google drive synchronise automatique des photos. comment changer ce setting ?
...
Je vérifie la procédure actuelle côté Google Drive sur Mac, puis je vous donne le chemin exact dans les réglages.
...
Oui. Sur Mac, cela se change dans **Google Drive for desktop**.
...
Et si vous voulez éviter que cela reparte automatiquement à chaque démarrage du Mac, allez dans **Préférences → Advanced Settings** puis décochez **“Launch Google Drive when you login to your computer”**. citeturn705751view1

Si vous voulez, je peux vous donner la procédure exacte selon votre cas :
1. arrêt de la synchro du dossier **Images/Pictures**,
2. arrêt de l’upload vers **Google Photos**,
3. ou arrêt complet de **Google Drive au démarrage**.
