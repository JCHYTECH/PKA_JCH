...
```dataview
TABLE source_file, type FROM #community/Biodiversity_Platforms
SORT file.name ASC
```

## Connections to other communities
- 1 edge to [[_COMMUNITY_GBIF Data Sources & APIs]]

## Top bridge nodes
- [[Observation.org  Observation International]] - degree 2, connects to 1 community