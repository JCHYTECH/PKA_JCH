...
```dataview
TABLE source_file, type FROM #community/GBIF_Data_Sources_&_APIs
SORT file.name ASC
```

## Connections to other communities
- 3 edges to [[_COMMUNITY_PWA App & Deployment]]
- 3 edges to [[_COMMUNITY_Species Search & Geolocation Logic]]
- 1 edge to [[_COMMUNITY_Biodiversity Platforms]]

## Top bridge nodes
- [[GBIF Occurrence Search API (api.gbif.orgv1occurrencesearch)]] - degree 5, connects to 2 communities
- [[GBIF Species Match API (api.gbif.orgv1speciesmatch and speciessearch)]] - degree 3, connects to 2 communities
- [[GBIF — Global Biodiversity Information Facility]] - degree 7, connects to 1 community
- [[gbif_wildlife_scout.py — Python script for local wildlife querying via pygbif]] - degree 3, connects to 1 community