...
| Stockage | microSD industrielle | Mouser / DigiKey | flash SPI — *capacité limitée pour images 5MP* | À chiffrer | À confirmer | Moyen | ADR-004 |
| Batterie | 2× 18650 LiFePO4 (~2 Ah/cell) | Farnell / AliExpress pro | Li-Ion 18650 — *risque thermique boîtier IP67* | ~8–15 € le pack | À confirmer | Moyen | ADR-005 |
| Solaire | Panneau 6V 2W + MPPT CN3791 | AliExpress / Mouser | Aucun (P0 batterie seule) — *autonomie 60 j suffisante P0* | ~8–15 € | À confirmer | Bas | ADR-005 — **footprint prévu, hardware non câblé P0, achat différé P1** |
...
| Batterie | 18650 LiFePO4 3.2 V 2000 mAh | Enerprof / NKON / Keeppower selon stock EU | spécialistes batterie EU, évite marketplace douteuse | pack ENERpower LiFePO4 si tension compatible | Valider pack 1S/2P vs architecture avant achat |
| Solaire/MPPT | CN3791 module ou équivalent 6 V | DFRobot/Waveshare/Soldered/DigiKey si dispo | modules CN3791 souvent marketplace ; préférer doc claire | Mouser composants discrets si PCB custom | Attendre architecture batterie finale |
...
- **Batterie :** ne pas confondre Li-ion 3.7 V et LiFePO4 3.2 V ; beaucoup de résultats 18650 sont Li-ion.
