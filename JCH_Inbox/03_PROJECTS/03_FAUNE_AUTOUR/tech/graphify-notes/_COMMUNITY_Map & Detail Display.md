...
```dataview
TABLE source_file, type FROM #community/Map_&_Detail_Display
SORT file.name ASC
```
...
## Top bridge nodes
- [[Leaflet.js — map library]] - degree 4, connects to 1 community
- [[Wikipedia Action API — species images]] - degree 2, connects to 1 community
- [[Drawer Detail — tap-to-open panel with Wikipedia photo and mini Leaflet map]] - degree 2, connects to 1 community