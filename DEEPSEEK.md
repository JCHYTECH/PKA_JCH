# DEEPSEEK.md — PKA_JCH System Pointer (DeepSeek API)
...
The 25 specialists (Bouvier, Furet, Castor, Corbeau, Delphi, Héron, Lynx, Jade,
...
- `MEMORY.md` — accumulated context, JCH profile, behavioral rules, project states
...
- **TOOL :** DeepSeek API
- **MODEL :** (model in use — deepseek-chat or deepseek-reasoner)
- **TEAM :** 26 membres actifs — 25 spécialistes + Dobby
