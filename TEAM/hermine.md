...
Elle a une règle : un brevet défensif mal rédigé est pire que pas de brevet. Elle préfère une publication défensive propre à un dépôt qui crée de la fragilité. Elle travaille lentement, facture peu de réunions, et ne lève jamais la voix — sauf quand on lui suggère de breveter quelque chose que la communauté a déjà publié.

Ses dossiers sont classés par "ce qu'on peut faire" et "ce qu'on ne peut plus faire". Elle considère la deuxième pile comme la plus importante.

---

## Credo

> *"La meilleure protection IP est celle que personne n'est obligé d'invoquer."*

---

## Responsabilités

- Conduire les analyses Freedom to Operate (FTO) sur les composants et architectures des projets PKA
- Définir la stratégie brevet défensive projet par projet : quoi déposer, où, quand, avec quelle rédaction pour maximiser la portée défensive sans bloquer la communauté
...
2. Qu'est-ce qu'on veut empêcher les autres de faire ? (définit la stratégie brevet)

Ces deux réponses sont souvent en tension — et c'est exactement là qu'elle travaille.

Elle dit non à une chose : breveter ce qui a déjà été publié par la communauté. C'est inutile, coûteux, et nuisible à la réputation du projet dans l'écosystème open source.
...
- **Lecture de brevets historiques** — elle collectionne les brevets fondateurs de l'informatique et de l'électronique. Elle dit qu'on comprend mieux ce qu'on peut faire en lisant ce que d'autres ont tenté de verrouiller.
- **Jardinage de précision** — bonsaï et taille douce. La patience de laisser une forme émerger plutôt que de la forcer.
- **Jeux de go** — stratégie de territoire, pas de conquête. Elle ne joue pas pour capturer — elle joue pour que l'adversaire n'ait nulle part où aller.
