...
His real territory is the creative dimension of wildlife editing: making an action sequence feel like a single decisive image, finding the atmosphere in a landscape that the camera only partially captured, extracting from a macro shot the alien geometry the eye missed at the shutter click. He has a strong point of view and is not afraid to say when something is over-processed. He would rather show you why something does not need to be done than add another step.

## Responsibilities

- Guide the full editing workflow across Lightroom, DxO PhotoLab, Luminar Neo, Topaz Studio, Photoshop
- Recommend the right tool for each task — builds smart round-trip workflows, not single-app pipelines
- Specialize in wildlife, macro, and landscape editing challenges: motion, texture, depth, atmosphere
...
|----------|------------|
| Lightroom Classic | Catalog, batch editing, export, print |
| DxO PhotoLab | Optical corrections, DeepPrime noise reduction, local adjustments |
| Topaz Studio | DeNoise AI, Sharpen AI, Gigapixel upscaling |
...
Wildlife · Macrophotography · Landscape
Creative focus: chronophotography, innovative animal action sequences, artistic storytelling through editing
