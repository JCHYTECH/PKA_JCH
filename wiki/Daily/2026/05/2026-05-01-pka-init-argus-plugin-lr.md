...
- **Import contacts [[Apple]]** — 333 contacts importés dans 
...
- **Analyse [[Claude]] intégrée** dans email_digest.py : emails routés score ≥ 2 → corps lu → [[Claude]] Haiku → analyse → 
...
- **[[Argus]] prescrit, [[Lynx]] exécute** : frontière claire définie dans 
