...
- **Argus #23 + Pie #24 ajoutés** dans `CLAUDE.md` et `TEAM/ROSTER.md` (étaient dans team.db mais absents des markdown)
- **Typo chemin DB corrigée** dans CLAUDE.md : `PKA _JCH` → `PKA_JCH`
