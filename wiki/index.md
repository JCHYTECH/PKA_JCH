...
|---|---------|--------|-------------|
| 01 | 🤖 AI & Outils | `Knowledge/AI-Tools/` | Outils IA, workflows, automatisations, PKA système |
| 02 | 🗓️ Journal | `Daily/YYYY/MM/` | Notes quotidiennes — YYYY-MM-DD-slug.md |
...
- **Dernière daily note :** voir `Daily/2026/05/` (trié par date)
- **Capture brute :** déposer dans `raw/` → `/ingest` pour traitement
- **Recherche :** `/query [terme]`
- **Santé du vault :** `/lint`
