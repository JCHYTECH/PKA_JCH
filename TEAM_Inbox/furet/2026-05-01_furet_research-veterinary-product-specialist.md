...
**Target expertise:** Médecine vétérinaire interne — chats et chiens — spécialisation allergologie (respiratoire, alimentaire, environnementale). Analyse de publications scientifiques → arguments produits pour vétérinaires praticiens et propriétaires d'animaux.

---

### Ce que cette personne fait

- **Veille scientifique** : lit et sélectionne les publications pertinentes pour les produits Vetalyx (IVD diagnostics + nutraceutiques/suppléments)
...
- **Allergologie vétérinaire** :
  - Allergies alimentaires (protéines, hydrolysats, régimes d'élimination)
  - Allergies respiratoires (rhinite, bronchite, asthme félin)
  - Dermatite atopique, hypersensibilité environnementale
- **Lecture critique de publications** : évaluation de la méthodologie, niveau de preuve (EBM vétérinaire)
- **IVD en médecine vétérinaire** : tests allergènes, panels diagnostics, interprétation des résultats
- **Nutraceutiques** : acides gras oméga, probiotiques, suppléments immunitaires — état de la preuve scientifique
- **Communication scientifique** : rédaction d'arguments adaptés selon l'audience (clinicien vs propriétaire)
