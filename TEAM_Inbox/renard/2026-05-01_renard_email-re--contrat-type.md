...
✅ **Immédiat** :
- Vérifier le destinataire correct pour cette demande
- Consulter s'il existe déjà un modèle de contrat de location chez JCHyTech

✅ **Court terme** :
- Élaborer un **contrat-type de location** couvrant :
  - État/inventaire de l'équipement (photos datées)
  - Durée et prix de location
  - Responsabilité du locataire en cas de dommage
  - Assurance obligatoire
  - Modalités de restitution
  - Litiges et juridiction compétente (Belgique)
